...
var require_utils = __commonJS({
  "node_modules/qs/lib/utils.js"(exports2, module2) {
    ...
    var defineProperty2 = require_es_define_property();
...
var Poll = class {
  ...
  fire() {
    ...
    if (this.inFlight && this.mode === "cancel") {
      (_a = this.currentCancel) == null ? void 0 : _a.call(this);
    }
      ...
      ({ onStart, onFinish }) => {
        ...
        this.reload({
          ...
          onCancelToken: (token) => {
            ...
            (_a = resolved.onCancelToken) == null ? void 0 : _a.call(resolved, token);
          },
          onFinish: (visit) => {
            var _a;
            onFinish();
            (_a = resolved.onFinish) == null ? void 0 : _a.call(resolved, visit);
          }
        });
      },
      {
...
function usePoll(interval, requestOptions = {}, options = {
  ...
  (0, import_react14.useEffect)(() => {
    ...
    return () => {
      var _a;
      return (_a = pollRef.current) == null ? void 0 : _a.destroy();
    };
  }, []);
  return {
    stop: () => {
      var _a;
      return (_a = pollRef.current) == null ? void 0 : _a.stop();
    },
    start: () => {
      var _a;
      return (_a = pollRef.current) == null ? void 0 : _a.start();
    }
  };
}

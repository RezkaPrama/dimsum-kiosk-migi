...
export interface MerchantSettings {
  ...
  merchantPin: string; // PIN for dashboard access, e.g. "1234"
  ...
  // QRIS gambar statis milik toko (kalau diisi, dipakai menggantikan QR simulasi)
